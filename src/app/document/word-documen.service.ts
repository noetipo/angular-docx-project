    ...
    const doc = new Document({
      sections: [{
        ...
        children: [
          ...
          new Paragraph({
            text: "",
            spacing: { before: 200, after: 200 }  // Espacio entre tablas
          }),
                        ...
                        rows: [
                            ...
                            children: [
                              new TableCell({
                                ...
                                children: [
                                  new Paragraph({
                                    children: [
                                      new TextRun({ text: "Orden de Verificación N° " }),
                                      new TextRun({
                                        text: "(CODIGO DE LA OSPE)-2024-VCA-(NUMERO DEL CASO)-084-001",
                                        bold: true,
                                      })
                                    ]
                                  })
                          ...
                          new TableRow({
                            children: [
                              new TableCell({
                                margins: defaultCellMargins,
                                children: [new Paragraph("Razón Social/ Apellidos y Nombres:")],
                                columnSpan: 2
                              })
                            ]
                          }),
                          new TableRow({
                            children: [
                              new TableCell({
                                margins: defaultCellMargins,
                                children: [new Paragraph("Tipo y Número de Documento:")],
                                columnSpan: 2
                              })
                            ]
                          }),
                          new TableRow({
                            children: [
                              new TableCell({
                                margins: defaultCellMargins,
                                children: [new Paragraph("Domicilio real ( ) / fiscal ( ):")],
                                columnSpan: 2
                              })
                            ]
                          })
                        ...
                        rows: [
                          new TableRow({
                            children: [
                              ...
                              new TableCell({
                                margins: defaultCellMargins,
                                children: [new Paragraph("Período a Verificar – Fecha de Inicio de la afiliación hasta la fecha de acreditación del asegurado")],
                          ...
                          ...Array(3).fill(null).map(() => new TableRow({
                            children: [
                              ...
                              new TableCell({ children: [new Paragraph("")] }),
                              new TableCell({ children: [new Paragraph("")] }),
                              new TableCell({ children: [new Paragraph("Desde el aa/mm al aa/mm")] })
                            ]
                          }))
                        ]
                      })
                    ...
                    children: [
                      ...
                      new Table({
                        ...
                        rows: [
                          ...
                          ...Array(2).fill(null).map(() => new TableRow({
                            children: [
                              new TableCell({ children: [new Paragraph("")] }),
                              new TableCell({ children: [new Paragraph("")] }),
                              new TableCell({ children: [new Paragraph("")] })
